...
public class camera : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            Vector3 p01 = p0 - Camera.main.transform.right * Input.GetAxisRaw("Mouse X") * 0.2f * Time.timeScale;
            Vector3 p03 = p01 - Camera.main.transform.up * Input.GetAxisRaw("Mouse Y") * 0.2f * Time.timeScale;
