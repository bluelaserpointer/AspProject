...
public class RotateModel : MonoBehaviour
{
    ...
    void Initialized()
    {
        ...
        m_axis = GameObject.Find("Axis_R").transform;
    ...
    void MovingModel()
    {
        ...
        m_model.transform.localEulerAngles += speed * offset * 3;
        //m_axis.transform.localEulerAngles += speed * offset * 3;
    ...
    void MoveComplete()
    {
        ...
        switch (m_axisState)
        {
            case AxisState.X:
                m_xyz[0].GetComponent<MeshRenderer>().material.SetColor("_Color", m_axisColors[0]);
                m_xyz[1].gameObject.SetActive(true);
                m_xyz[2].gameObject.SetActive(true);
                Debug.Log("1");

                break;
            case AxisState.Y:
                m_xyz[1].GetComponent<MeshRenderer>().material.SetColor("_Color", m_axisColors[1]);
                m_xyz[0].gameObject.SetActive(true);
                m_xyz[2].gameObject.SetActive(true);
                Debug.Log("1");
                break;
            case AxisState.Z:
    ...
    void MouseDown(string axisName)
    {
        ...
        switch (axisName)
        {
            case "X":
                ...
                m_xyz[1].gameObject.SetActive(false);
                m_xyz[2].gameObject.SetActive(false);
                Debug.Log("4");
                break;
            case "Y":
                m_axisState = AxisState.Y;
                m_xyz[0].gameObject.SetActive(false);
                m_xyz[2].gameObject.SetActive(false);
                Debug.Log("4");
                break;
            case "Z":
